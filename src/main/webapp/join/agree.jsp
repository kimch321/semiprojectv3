...
<div class="container bg-white">
    ...
    <div id="main">
        ...
        <div class="card card-body bg-light mt-5 mx-3">
            <h3>사이트 이용 약관</h3>
            <form name="agreefrm" id="agreeftm">
...
Copyright © Kakao Corp. All rights reserved.
                ...
                <div class="form-check d-flex justify-content-end mt-3 pe-1">
        ...
        <div class="card card-body bg-light my-5 mx-3">
...
Copyright © Kakao Corp. All rights reserved.
        ...
        <div class="d-flex justify-content-center mt-4">
            <div>
                <button type="button" id="agreeOk" class="btn btn-success">모두 동의합니다</button>
                <button type="button" id="agreeNo" class="btn btn-danger">동의하지 않습니다</button>
            </div>
        </div>
    </div>
